...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=18&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=Full+Stack+Developer+in+Progress...;DSA+%7C+C%2B%2B+%7C+Problem+Solver;Debugging+Life%2C+One+Commit+at+a+Time;404%3A+Sleep+Not+Found)](https://git.io/typing-svg)
...
Location :  India 🇮🇳
Status   :  Currently shipping code at 2AM ☕
...
```json
{
  ...
  "currently"     : ["DSA → LeetCode grind mode 🔥", "Full Stack Projects"],
